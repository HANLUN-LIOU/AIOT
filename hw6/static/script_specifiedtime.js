    ...
    function fetchDataAndUpdateChart() {
        ...
        fetch(`/get_data?start_time=${startDateTime}&end_time=${endDateTime}`)
            ...
            .then(data => {
                ...
                document.getElementById('avgTemperature').textContent = averageTemperature.toFixed(2) + ' °C';

                const averageHumidity = calculateAverageHumidity(data);
                console.log("Average Humidity:", averageHumidity);
                document.getElementById('avgHumidity').textContent = averageHumidity.toFixed(2) + ' %';
            })
