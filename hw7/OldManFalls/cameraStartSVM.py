...
# 開啟鏡頭
cap = cv2.VideoCapture("short_14.mp4")
...
# 加載模型
model = joblib.load('0507model/svm_model.pkl')
...
with mp_holistic.Holistic(
    ...
    while True:
        ...
        if not ret:  # 如果沒連接攝影機
            ...
            try:
                response = requests.post(
                    'http://10.10.38.48:5000/post_camera_frame', json=data)
        ...
        if results.pose_landmarks != None:
            ...
            if state[prediction[0]] == 'Fall down':
                print('Fall down')
